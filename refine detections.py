...
pulse actually begins and ends; the fitted sweep is only ever evaluated between those points.
...
def refine_one(data, fs, det, context=0.5, pad_hz=1500.0, snr_db=None, rel_db=None,
               min_points=8, max_rmse_bins=3.0, min_coverage=0.3):
    ...
    ridge_span = best_attempt["t_stop"] - best_attempt["t_start"]
